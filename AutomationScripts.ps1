...
"
    ...
    if ($Userchoice -eq 5) {Clear-Host "Please check your preferred web browser to download" {Start-Process 'https://github.com/Sagaichi/Powershell/blob/main/AutomaticWindowsUpdates'}}
